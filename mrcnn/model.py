...
# to go back to original implementation of matterport.
# import keras
...
class ProposalLayer(KE.Layer):
    ...
    # uncomment this section if we want it to work.
    def get_config(self):
...
class DetectionTargetLayer(KE.Layer):
    ...
    # uncomment this to go back to the past!
    def get_config(self):
